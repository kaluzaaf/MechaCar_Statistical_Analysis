...
library(tidyverse)
mecha_mpg <- read.csv(file='../Challenge/MechaCar_mpg.csv',check.names=F,stringsAsFactors = F) 
...
suspension_coil <- read.csv("../Challenge/Suspension_Coil.csv",stringsAsFactors = F,check.names = F)
